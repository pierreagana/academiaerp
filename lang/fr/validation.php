...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => "Le :attribute indiqué a été trouvé dans une fuite de données. Merci de choisir un autre :attribute.",
    ],
    ...
    'uploaded' => "Le fichier du champ :attribute n'a pas pu être téléversé (il dépasse peut-être la taille maximale autorisée par le serveur).",
    ...
    */
    ...
    'attributes' => [
        ...
        'photo' => 'photo',
        'name' => 'nom',
        'academic_class_id' => 'classe',
        'roll_number' => 'matricule',
