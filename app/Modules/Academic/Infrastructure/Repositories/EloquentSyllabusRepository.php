...
class EloquentSyllabusRepository implements SyllabusRepositoryInterface
{
    /**
     * Syllabuses have no school_id column of their own — scoped via the
     * academic_class relation, which is itself school-scoped.
     */
    private function scoped()
    {
        return Syllabus::whereHas('academicClass', function ($q) {
    ...
    public function create(array $data) { return Syllabus::create($data); }
