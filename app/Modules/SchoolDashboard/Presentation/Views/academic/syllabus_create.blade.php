    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <form action="{{ route('school.academic.syllabuses.store') }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <!-- Classe -->
                <div>
                    <label for="academic_class_id" class="block text-[13px] font-semibold text-slate-700 mb-1.5">Classe <span class="text-red-500">*</span></label>
                    <select id="academic_class_id" name="academic_class_id" required class="w-full bg-[#FAFBFC] border border-slate-200 text-slate-900 text-[14px] font-medium rounded-lg px-4 py-2.5 outline-none focus:border-[#2F5F76] focus:ring-1 focus:ring-[#2F5F76] transition shadow-sm appearance-none">
            ...
            <!-- Matières (Checkboxes) -->
            <div>
                <label class="block text-[14px] font-bold text-slate-800 mb-3 border-b border-slate-100 pb-2">Sélectionnez les matières à assigner <span class="text-red-500">*</span></label>
